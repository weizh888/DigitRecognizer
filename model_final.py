...
n_epoch = 10
for i in range(100): # Optimal is 40  
    model.fit_generator(datagen.flow(X_train, y_train, batch_size=32), len(X_train), nb_epoch=n_epoch, verbose=2)
    if (i+1)%5 == 0:
        filename = 'cycle' + str(i+1) + '_epoch' + str(n_epoch) + '_r15_s.5_wl2.csv' # cycle2_epoch10_s_wl1l2.csv  
