...
##plot(model, to_file='model_Conv_relu.png')

model.add(MaxPooling2D(pool_size=(2, 2)))
##plot(model, to_file='model_Conv_relu_MaxPool.png')

model.add(Convolution2D(nb_filter=64,nb_row=3,nb_col=3))
model.add(Activation("relu"))
##plot(model, to_file='model_Conv_relu_MaxPool_Conv_relu.png')

model.add(MaxPooling2D(pool_size=(2, 2)))
##plot(model, to_file='model_Conv_relu_MaxPool_Conv_relu_MaxPool.png')

model.add(Flatten())
##plot(model, to_file='model_Conv_relu_MaxPool_Conv_relu_MaxPool_Flat.png')
